...
def compute_rigid_contact_forces(
    ...
    This is the VBD analogue of MPM's per-collider impulse buffers: it produces a **contact-specific**
    force vector (world frame) for each rigid contact, rather than using per-body accumulators.
