...
class SolverVBD(SolverBase, CouplingInterface):
    ...
    def _rebuild_structural_graph_kkt(self) -> None:
        ...
        backend = rigid_vbd_kkt.StructuralGraphKKT(self.model, self.body_inv_mass_effective)
    ...
    def step(
        ...
        if not self._rigid_joint_global_iteration_indices:
            # Keep the baseline G=0/legacy hot path unchanged.
    ...
    def _solve_structural_graph_kkt(
        ...
        backend.solve(
            ...
            joint_cable_rest_kb_local=self.joint_cable_rest_kb_local,
            joint_cable_rest_twist=self.joint_cable_rest_twist,
