...
.. list-table::
   ...
   * - ``State.vbd.cable_tension``
     - VBD cable stretch tension magnitudes [N], joint-indexed and namespaced under ``state.vbd.cable_tension``.
